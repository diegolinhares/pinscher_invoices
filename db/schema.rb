...
ActiveRecord::Schema[7.1].define(version: 2023_11_26_160244) do
  ...
  create_table "invoice_emails", force: :cascade do |t|
    ...
    t.index ["email", "invoice_id"], name: "index_invoice_emails_on_email_and_invoice_id", unique: true
  ...
  create_table "invoices", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.serial "invoice_number", null: false
  ...
  create_table "tokens", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["token_value"], name: "index_tokens_on_token_value", unique: true
